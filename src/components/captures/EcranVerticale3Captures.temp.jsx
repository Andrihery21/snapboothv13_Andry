...
// Définitions locales des effets pour éviter les problèmes d'importation
const MAGICAL_EFFECTS = [
  { 
    id: 'cartoon', 
    name: 'Cartoon', 
...
// Fonction simplifiée pour composer les effets
async function composeEffects(inputCanvas, magicalId, normalId) {
