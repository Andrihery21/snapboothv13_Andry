...
import EffectUnivers from '../effects/EffectUnivers';
...
const DEFAULT_FILTER = 'EffectUnivers';
const CAPTURE_BUTTON_TEXT = 'Devenir une étoile';
const RESULT_TEXT = 'Votre photo avec effet Univers';
...
export default function EcranVerticale1Captures({ eventId }) {
  ...
  const checkPendingCommands = async () => {
    ...
    try {
      const { commands, error } = await fetchPendingCommands(SCREEN_TYPE, eventID);
          ...
          {!showAdminDashboard && (
            <>
              ...
              <header className="p-4 flex justify-between items-center">
                ...
                <h1 className="text-2xl font-bold text-white">Univers Cosmique</h1>
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-2xl aspect-[9/16] bg-black rounded-xl overflow-hidden border-4 border-purple-600 shadow-2xl">
                ...
                {!imgSrc && !montrerResultat && !montrerQRCode && webcamEstPret && (
                  <div className="mt-8 flex flex-col items-center">
                    {!montrerSelectionEffets ? (
                      ...
                      <div className="bg-black/70 p-4 rounded-xl border-2 border-purple-600 w-full max-w-2xl">
                        <h3 className="text-xl font-bold text-white mb-4 text-center">Choisissez votre style</h3>
                        <EffectUnivers onSelect={handleEffectSelect} />
                      </div>
                    )}
                  </div>
                )}
