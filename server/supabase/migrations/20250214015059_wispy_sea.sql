/*
  ...
  1. Nouvelle Table
    - `email_templates`
      ...
      - `email_type` (text, unique) - Type de template (ex: photo_share)
      - `email_content` (text) - Contenu du template avec variables
...
INSERT INTO email_templates (email_type, email_content)
VALUES (
  'photo_share',
  'Bonjour,
