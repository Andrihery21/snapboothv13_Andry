/*
  ...
  1. Nouvelle Table
    - `email_templates`
      ...
      - `template_type` (text, unique) - Type de template (ex: photo_share)
      - `template_content` (text) - Contenu du template avec variables
...
INSERT INTO email_templates (template_type, template_content)
VALUES (
  'photo_share',
  'Bonjour,
